...
public static void main(String[] args) {
		...
		String to = "banduhaladur@gmail.com";
		String from = "banduhaladur@gmail.com";
...
//	//this is responsible to send email..
	public static void sendEmail(String message, String subject, String to, String from) {
		...
		Session session=Session.getInstance(properties, new Authenticator() {
			@Override
			protected PasswordAuthentication getPasswordAuthentication() {				
				return new PasswordAuthentication("banduhaladur@gmail.com", "lchbggmonykkeooa\r\n"
						+ "");
			}
